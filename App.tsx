...
const Header: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? 'glass py-4 shadow-xl' : 'bg-transparent py-8'}`}>
    ...
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="max-w-4xl">
          ...
          <h1 className="text-6xl md:text-8xl font-bold leading-tight mb-8 tracking-tighter animate-fade-in-up delay-100">
          ...
          <p className="text-lg md:text-xl text-gray-400 mb-10 max-w-2xl leading-relaxed animate-fade-in-up delay-200">
      ...
      <div className="absolute bottom-10 right-10 hidden lg:flex flex-col gap-4 animate-fade-in-up delay-400">
    ...
    <div className="min-h-screen gradient-bg">
      ...
      <section id="info" className="py-20 container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Main Info */}
          <div className="glass p-8 rounded-3xl md:col-span-2 flex flex-col justify-between group hover:border-white/20 transition-all duration-500">
            <div>
            ...
            <div className="mt-12 flex flex-wrap gap-3">
              {FEATURES.map(f => (
                <span key={f.id} className="flex items-center gap-2 glass px-4 py-2 rounded-xl text-sm font-medium border-white/5 group-hover:border-white/10 transition-all duration-300">
          ...
          <div className="flex flex-col gap-6">
            <div className="glass p-8 rounded-3xl flex-1 flex flex-col justify-center items-center text-center">
              ...
              <button className="w-full bg-white text-black py-4 rounded-2xl font-bold mb-3 hover:scale-[1.02] transition-transform duration-300">
                Order Delivery
              </button>
              <button className="w-full glass py-4 rounded-2xl font-bold hover:bg-white/10 transition-colors duration-300">
                Takeaway Order
              </button>
            </div>
      ...
      <section className="py-20 glass border-y border-white/5">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-20">
          ...
          <div className="flex flex-col justify-center">
            <div className="p-10 bg-white text-black rounded-[3rem] text-center shadow-2xl">
              ...
              <div className="flex flex-col gap-3">
                 <button className="bg-black text-white py-4 rounded-2xl font-bold text-lg hover:scale-[1.02] transition-all">
                   Get Directions
                 </button>
